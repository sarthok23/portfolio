...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.timeline-item, .skill-category, .skill-category-new, .activity-card, .education-item, .project-card, .award-card, .languages-section-new');
...
revealStyles.textContent = `
    ...
    .skill-category-new.revealed,
    .activity-card.revealed,
    .education-item.revealed,
    .project-card.revealed,
    .award-card.revealed,
    .languages-section-new.revealed {
        opacity: 1;
...
const animateProgressBars = () => {
    const progressBars = document.querySelectorAll('.language-progress, .language-progress-new');
    progressBars.forEach(bar => {
        if (bar.classList.contains('language-progress-new')) {
